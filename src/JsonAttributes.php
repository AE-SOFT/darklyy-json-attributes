 ...
 * @mixin Collection
 */
class JsonAttributes implements ArrayAccess, Arrayable, Countable, IteratorAggregate, Jsonable, JsonSerializable
{
    ...
    public function __construct(Model $model, string $sourceAttributeName)
    {
        ...
        $this->collection = new Collection($this->getRawJsonAttributes());
    }
    ...
    protected function getRawJsonAttributes(): array
    {
